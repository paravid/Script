...
function Fire()
	...
	repeat
		...
		if DOFIRE > 4 then
			...
			NewSound({ID = 1,PARENT = SMG,VOLUME = 0.45,PITCH = MRANDOM(9,11)/7.5,LOOP = false,MAXDISTANCE = 125,EMITTERSIZE = 10,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
		end
		GYRO.CFrame = CF(RIGHTARM.CFrame*CF(0,0.8,0).p,MOUSEPOS)*ANGLES(RAD(90),RAD(45),0)
...
function Molotov()
	if ATTACKING == false then
		ATTACKING = true		
		USEDEFAULTANIMATIONS = false
		NewSound({ID = 2,PARENT = ROOT,VOLUME = 5,PITCH = 1,LOOP = false,MAXDISTANCE = 125,EMITTERSIZE = 35,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
...
function LooseBike()
	if ROOT.Velocity.Magnitude <= 1 then
		...
		coroutine.resume(coroutine.create(function()
			...
			local VROT = NewSound({ID = 1,PARENT = FAKEMOTOR,VOLUME = 1.5,PITCH = 3,LOOP = true,MAXDISTANCE = 125,EMITTERSIZE = 15,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
			NewSound({ID = 1,PARENT = FAKEMOTOR,VOLUME = 10,PITCH = 1,LOOP = false,MAXDISTANCE = 125,EMITTERSIZE = 35,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
			for i = 1, 200 do
				Swait()
			...
			if DIDHIT == true then
				...
				NewSound({ID = 2,PARENT = FAKEMOTOR,VOLUME = 7.5,PITCH = 1.5,LOOP = false,MAXDISTANCE = 550,EMITTERSIZE = 75,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
...
function GrabBazooka()
	if HASBAZOOKAEQUIPPED == false then
		...
		NewSound({ID = 1,PARENT = ROOT,VOLUME = 1,PITCH = MRANDOM(9,11)/15,LOOP = false,MAXDISTANCE = 75,EMITTERSIZE = 15,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
		...
		local Fire = function()
			...
			NewSound({ID = 4,PARENT = BAZOOKA,VOLUME = 5,PITCH = MRANDOM(9,11)/10,LOOP = false,MAXDISTANCE = 80,EMITTERSIZE = 15,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
			NewSound({ID = 4,PARENT = ROCKET,VOLUME = 5,PITCH = MRANDOM(9,11)/10,LOOP = false,MAXDISTANCE = 80,EMITTERSIZE = 15,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
			...
			NewSound({ID = 1,PARENT = ROCKET,VOLUME = 7,PITCH = MRANDOM(8,12)/10,LOOP = false,MAXDISTANCE = 300,EMITTERSIZE = 15,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
			local B = IT("Explosion")
			B.BlastPressure = 0
			B.BlastRadius = 15
...
local e = game:GetService('UserInputService').InputBegan:Connect(function(key, chatting)
	...
	if USEDEFAULTANIMATIONS then
		...
		elseif V2 == "y" then
			NewSound({ID = 8,PARENT = ROOT,VOLUME = 10,PITCH = 1,LOOP = false,MAXDISTANCE = 125,EMITTERSIZE = 50,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
		elseif V2 == "u" then
			NewSound({ID = 1,PARENT = ROOT,VOLUME = 10,PITCH = 1,LOOP = false,MAXDISTANCE = 125,EMITTERSIZE = 50,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
		elseif V2 == "g" then
			NewSound({ID = 1,PARENT = ROOT,VOLUME = 10,PITCH = 1,LOOP = false,MAXDISTANCE = 125,EMITTERSIZE = 50,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
...
local f = game:GetService("RunService").RenderStepped:Connect(function()
	...
	if ROOT:FindFirstChild("MOTORHUM") == nil then
		MOTORHUM = NewSound({ID = 1,PARENT = ROOT,VOLUME = 1.5,PITCH = 1,LOOP = true,MAXDISTANCE = 125,EMITTERSIZE = 15,PLAYING = true,PLAYONREMOVE = false,DOESDEBRIS = true})
		MOTORHUM.Name = "MOTORHUM"
	else
