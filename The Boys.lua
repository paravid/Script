...
local axeAcc = Char:FindFirstChild("FireaxeAccessory")
if not axeAcc then
    warn("FireaxeAccessory não encontrado!")
else
    local handle = axeAcc:FindFirstChild("Handle")
    if not handle then
        warn("Handle não encontrado dentro do FireaxeAccessory!")
    else

        handle.Parent = Axe.PrimaryPart
        ...
        weld.Name = "AxeHatWeld"
        weld.Part0 = Axe.PrimaryPart
        weld.Part1 = handle
        weld.C0 = CFrame.new(0, 0, 0) * CFrame.Angles(0, 0, -80.1)
        weld.Parent = Axe.PrimaryPart

        handle.CFrame = Axe.PrimaryPart.CFrame * CFrame.new(0, 0, 0)
